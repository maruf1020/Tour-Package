...
public class andojs extends AppCompatActivity {
    ...
    private String BASE_URL = "http://192.168.0.106:3000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Nodejs login");
            ...
            public void onClick(View view) {
                ...
                call.enqueue(new Callback<Void>() {
                    ...
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        ...
                        if (response.code() == 200) {
                            Toast.makeText(andojs.this, "Signed up successfully", Toast.LENGTH_SHORT).show();
                        } else if (response.code() == 400) {
                            Toast.makeText(andojs.this, "Already registered", Toast.LENGTH_SHORT).show();
                        }
